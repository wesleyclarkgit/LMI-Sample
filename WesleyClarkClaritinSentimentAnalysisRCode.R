...
#Apriori rules method - Unfortunately I could not get this to work properly for the 3rd element.
#aa<-Claritin[ , c('INSOMNIA', 'GENDER',  'DIZINESS')]
#aa$INSOMNIA<-as.factor(aa$INSOMNIA)

#aa$GENDER<-as.factor(aa$GENDER)
#aa$DIZINESS<-as.factor(aa$DIZINESS)
